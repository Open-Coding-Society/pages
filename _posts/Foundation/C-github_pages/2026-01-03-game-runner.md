...
{% capture code1 %}
import GameEnvBackground from '/assets/js/GameEnginev1.5/essentials/GameEnvBackground.js';
import Player from '/assets/js/GameEnginev1.5/gameObjects/Player.js';
import Npc from '/assets/js/GameEnginev1.5/gameObjects/Npc.js';
...
```javascript
import GameControl from '/assets/js/GameEnginev1.5/essentials/GameControl.js';

...
{% capture code1 %}
import GameEnvBackground from '/assets/js/GameEnginev2/essentials/GameEnvBackground.js';
import Player from '/assets/js/GameEnginev2/gameObjects/Player.js';
import Npc from '/assets/js/GameEnginev2/gameObjects/Npc.js';
...
```javascript
import GameControl from '/assets/js/GameEnginev2/essentials/GameControl.js';

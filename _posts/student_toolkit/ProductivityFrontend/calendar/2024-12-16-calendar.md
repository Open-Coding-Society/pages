...
#periodFilterDropdown:hover {
    background-color: var(--bg-2, #f0f0f0);
}
</style>
...
<div id="eventModal" class="fixed z-[99999] inset-0 flex items-center justify-center bg-opacity-70 backdrop-blur-sm py-4 overflow-y-auto hidden">
    <div class="relative mx-auto my-4 p-8 rounded-2xl shadow-2xl max-w-xl max-h-[90vh] overflow-y-auto w-full font-sans modal-content">
        ...
        <div class="modal-body">
            ...
            <label for="editGroupName" class="block mt-2 mb-1 text-lg font-semibold">Group Name (optional):</label>
            <input type="text" id="editGroupName" disabled placeholder="e.g., Team Alpha" class="w-full p-3 rounded-xl border border-gray-700 text-base box-border mb-4">
        </div>
...
<script type="module">
    ...
    let currentPeriodFilter = null; // Track the class period filter (P1, P2, etc.)
        ...
        function displayCalendar(events) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function (info) {
                    // TODO: Add login check before allowing appointment creation
                    // if (!window.user || !window.user.uid) {
                    //     alert('You must be logged in to create an appointment. Please log in and try again.');
                    //     return;
                    // }
                    ...
                    document.getElementById("saveButton").onclick = function () {
                        ...
                        const newEventPayload = {
                            ...
                            type: document.getElementById("editEventType").value // Event or Appointment
                        };

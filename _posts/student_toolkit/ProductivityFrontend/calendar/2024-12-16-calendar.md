        ...
        function displayCalendar(events) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function (info) {
                    ...
                    if (currentEvent.extendedProps.isBreak) {
                        // For break events, only show delete button

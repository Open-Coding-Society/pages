...
class GameCore {
    ...
    import('../../GameEnginev1.1/Leaderboard.js')
        .then(mod => {
            try {
    ...
    _initializePauseFeature() {
        ...
        try {
            import('../../GameEnginev1.1/PauseFeature.js').then(mod => {
    ...
    _createTopControls() {
        ...
        Promise.all([
            import('../../GameEnginev1.1/ScoreFeature.js'),
            import('../../GameEnginev1.1/PauseFeature.js'),
            import('../../GameEnginev1.1/LevelSkipFeature.js'),
            import('./cheats.js')

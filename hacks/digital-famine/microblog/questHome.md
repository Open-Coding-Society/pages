...
breadcrumb: true
author: Lucas M, Sloane Sommers, Krishna Visvanath
---
...
<script>
    ...
    var nodes = new vis.DataSet([
        {id: 1, label: 'API blog', url: '{{ base.siteurl }}/pages-core/digital-famine/microblog/api/', title: 'Open Node 1',
         image: defaultImgUrl,
        ...
        {id: 6, label: 'Threat Modeling', url: '{{ base.siteurl }}/pages-core/digital-famine/microblog/Flappy-Threat-Model/', title: 'Open Node 6',
         image: defaultImgUrl,
         longTitle: 'Backup Array Zeta',
         description: 'Cold backup array; bring spare modules to reactivate.',
         tags: ['backup','spare-parts']},
        {id: 7, label: 'Vault', url: '{{ base.siteurl }}/pages-core/digital-famine/microblog/vault/', title: 'Open Node 7',
         image: defaultImgUrl,

...
class MansionLevel2_Cemetery {
  constructor(gameEnv) {
    ...
    // === BACKGROUND SETUP ===
    const backgroundImage = path + "/images/projects/mansiongame-new/CemeteryMainBackground.png";
    ...
    const gravestoneImagePaths = [1, 2, 3, 4, 5, 6].map(num => 
      path + `/images/projects/mansiongame-new/gravestone_${num}.png`
    );
  ...
  showKeyEarnedPopup() {
    ...
    keyImage.src = path + '/images/projects/mansiongame-new/key_lvl3.png';

...
class MansionLevel6 {
   constructor(gameEnv){
        ...
        const levelMusic = new Audio(path + `/assets/sounds/mansiongame-new/${randomSong}`);
        ...
        const image_src_chamber = path + "/images/projects/mansiongame-new/bgBossIntroChamber.png"
        ...
        const sprite_src_zombie = path + "/images/projects/mansiongame-new/zombieNpc.png";
        ...
        const sprite_src_bossdoor = path + "/images/projects/mansiongame-new/invisDoorCollisionSprite.png";
                ...
                this.dialogueSystem.addButtons([
                    {
                        ...
                        action: () => {
                            ...
                            if (gameEnv && gameEnv.gameControl) {
                                ...
                                const audio = new Audio(path + "/assets/sounds/mansiongame-new/SkeletonLord.mp3");
                                audio.loop = true;
                                audio.volume = 0.4;
        ...
        const sprite_src_chair = path + "/images/projects/mansiongame-new/invisDoorCollisionSprite.png";
        ...
        const sprite_src_chair2 = path + "/images/projects/mansiongame-new/invisDoorCollisionSprite.png";

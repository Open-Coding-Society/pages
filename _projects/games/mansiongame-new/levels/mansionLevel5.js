...
class MansionLevel5 {
    constructor(gameEnv) {
        ...
        this.backgroundMusic = new Audio(this.path + '/assets/sounds/mansiongame-new/SpookieDookie.mp3');
    ...
    createBackgroundData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-new/background_lvl5.png",
    ...
    createPlayerData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-new/full_anims_spook.png",
            SCALE_FACTOR: 5,
            STEP_FACTOR: 800,
            ANIMATION_RATE: 20,
    ...
    createWheelHostData() {
        return {
            ...
            src: this.path + "/images/projects/mansiongame-new/skeleton_key.png", 
            SCALE_FACTOR: 8,
            ANIMATION_RATE: 100,
    ...
    createFinishDoorData() {
        ...
        return {
            ...
            src: this.path + "/images/projects/mansiongame-new/door_lvl5.png",
            SCALE_FACTOR: 1,
            ANIMATION_RATE: 100,
    ...
    winLevel() {
        ...
        dialogueSystem.showDialogue(
            ...
            'Level 5 Complete',
            this.path + '/images/projects/mansiongame-new/key_lvl3.png'
        );
    ...
    showSolvedMessage() {
        ...
        dialogueSystem.showDialogue(
            ...
            'Mansion Wheel',
            this.path + '/images/projects/mansiongame-new/objective.png'
        );
    }

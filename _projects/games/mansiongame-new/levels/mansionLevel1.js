...
class MansionLevel1 {
  ...
  if (gameEnv && gameEnv.gameControl) {
    ...
    if (!gc.levelMusic) {
      gc.levelMusic = new Audio(path + "/assets/sounds/mansiongame-new/shadow_music_level1.mp3");
    ...
    // Background data
    const image_background = path + "/images/projects/mansiongame-new/kitchen_lvl1.png"; // be sure to include the path
    ...
    const sprite_src_mc = path + "/images/projects/mansiongame-new/spookMcWalk.png"; // be sure to include the path
      ...
      const sprite_src_pantrydoor = path + "/images/projects/mansiongame-new/invisDoorCollisionSprite.png"; // replace with your door sprite if needed

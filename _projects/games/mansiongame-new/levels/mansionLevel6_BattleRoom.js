...
class MansionLevel6_BattleRoom {
    constructor(gameEnv) {
        ...
        // --- Floor ---
        const image_src_floor = path + "/images/projects/mansiongame-new/bossFloorPattern.png";
        ...
        // --- Player ---
        const sprite_src_mc = path + "/images/projects/mansiongame-new/spookMcWalk.png";
        ...
        // Add the Reaper
        const sprite_src_enemy = path + "/images/projects/mansiongame-new/Reaper.png";
        ...
        const sprite_src_body = path + "/images/projects/mansiongame-new/ReaperMainBody.png";
        ...
        const sprite_reaper_src = path + "/images/projects/mansiongame-new/ReaperMainBody.png";
        ...
        const sprite_arm_left_empty = path + "/images/projects/mansiongame-new/ReaperLeftHandEmpty.png";
        const sprite_arm_left_scythe = path + "/images/projects/mansiongame-new/ReaperLeftHandScythe.png";
        const sprite_arm_right_empty = path + "/images/projects/mansiongame-new/ReaperRightHandEmpty.png";
        const sprite_arm_right_scythe = path + "/images/projects/mansiongame-new/ReaperRightHandScythe.png";
        ...
        const sprite_scythe_src = path + "/images/projects/mansiongame-new/fireball.png";

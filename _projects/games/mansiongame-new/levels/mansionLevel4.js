...
class MansionLevel4 {
    constructor(gameEnv) {
        ...
        // Background data
        const image_background = path + "/images/projects/mansiongame-new/image_lvl4.png";
        ...
        // Adding Music
        this.backgroundMusic = new Audio(path + '/assets/sounds/mansiongame-new/SpookieDookie.mp3');

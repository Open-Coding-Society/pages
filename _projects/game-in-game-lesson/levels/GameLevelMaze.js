...
import GameLevelMazeSub from '/assets/js/projects/game-in-game-lesson/levels/GameLevelMazeSub.js';
...
class GameLevelMaze {
  constructor(gameEnv) {
    ...
    const image_data_cave = {
      ...
      src: "/images/projects/game-in-game-lesson/dungeon.png",
    ...
    const sprite_data_gate = {
      ...
      src: "/images/projects/game-in-game-lesson/robot.png",
      SCALE_FACTOR: 8,
      ANIMATION_RATE: 100,

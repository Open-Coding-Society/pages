...
*   ✅ **Do this:** `<h1 class="ocs_section-title">Main Heading</h1>`
...
<h1 class="ocs_section-title">About Our Project</h1>
<p class="ocs_lead">We are a group of CSP students building a cool web app.</p>
```
...
<div class="ocs_card">
  <p class="ocs_text">You <strong>must</strong> commit your code daily.</p>
  <p class="ocs_text">It is <em>highly recommended</em> to leave comments.</p>
</div>
```
...
<div class="ocs_card">
  <h2 class="ocs_section-title">Setup Instructions</h2>
  <p class="ocs_description">Follow these steps to initialize the environment.</p>
  <ul>
    <li>Python 3.9+</li>
    <li>VS Code</li>
  </ul>
...
<div class="large-title">hey</div>
<span class="sub-title">it's me</span>
<div class="normal">it's verity</div>
```
...
<div class="body-text">pat a cat? Well good for you we will give step by step instructions on how to pat a cat! yay!</div>
...
<div class="list-item">3. congrats! you pat a cat :D</div>
```

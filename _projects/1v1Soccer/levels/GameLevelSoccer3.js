...
class GameLevelSoccer3 {
  constructor(gameEnv) {
    ...
    const sprite_data_cpu = {
      id: 'CPU-ChillGuy',
      greeting: 'CPU Opponent: Chill Guy',
      src: `${path}/images/projects/1v1Soccer/chillguy.png`,
      SCALE_FACTOR: 5,
      ANIMATION_RATE: 50,
...
export default GameLevelSoccer3;

...
class GameLevelSoccer1 {
  constructor(gameEnv) {
    ...
    const sprite_data_cpu = {
      id: 'CPU-Alex',
      greeting: 'CPU Opponent: Alex',
      src: `${path}/images/projects/1v1Soccer/Alex.png`,
      SCALE_FACTOR: 7,
      ANIMATION_RATE: 25,
...
export default GameLevelSoccer1;
